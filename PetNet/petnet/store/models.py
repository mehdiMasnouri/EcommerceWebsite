...
class Category(models.Model):
    ...
    # url representation of the title field
...
class Product(models.Model):
     ...
     ACTIVE = 'active'
     DELETED = 'deleted'
     # tupel for creating choice list
     STATUS_CHOICE = (
          (DRAFT , 'Draft'),
     ...
     # we need two function for thumbnail:
     # 1- resizeing image 
     # 2- uploading image

     # this function generate thumbnail base on desiered size
